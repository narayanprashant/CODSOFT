...
public class Menu extends JPanel {
    ...
    public void createGUI(){
        ...
        logoImage = new JLabel(new ImageIcon("C:/Users/prash/IdeaProjects/Number game/res/guess_the_number_logo2.jpg"));
        ...
        scoreLabel = new JLabel(new ImageIcon("C:/Users/prash/IdeaProjects/Number game/res/high_score_label.png"));
        scoreLabel.setBorder(new EmptyBorder(35, 0, 0, 0));
        scoreLabel.setAlignmentX(CENTER_ALIGNMENT);
        add(scoreLabel);

        // Setting up and Display the High Score
        scoreText = new JLabel(scoreFiles.showScore("C:/Users/prash/IdeaProjects/Number game/scores/high_point.txt") + " points for " + scoreFiles.showGames("C:/Users/prash/IdeaProjects/Number game/scores/high_point.txt") + " games");
        ...
        playButton = new JLabel(new ImageIcon("C:/Users/prash/IdeaProjects/Number game/res/play_button.png"));
        ...
        playText = new JLabel(new ImageIcon("C:/Users/prash/IdeaProjects/Number game/res/click_play.png"));
    ...
    public void linkPlay(JLabel jLabel){
        jLabel.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                scoreFiles.write("C:/Users/prash/IdeaProjects/Number game/scores/live_score.txt", 0);
    ...
    protected void paintComponent(Graphics g) {
        g.drawImage(new ImageIcon("C:/Users/prash/IdeaProjects/Number game/res/background1.jpg").getImage(), 0, 0, null);
    }
}
