...
public class Game extends JFrame {
    ...
    public Game() {
        ...
        this.setIconImage(Toolkit.getDefaultToolkit().getImage("C:/Users/prash/IdeaProjects/Number game/res/icon.png")); // Change the icon
    ...
    public void background_music() {
        try {
            ...
            String soundName = "C:/Users/prash/IdeaProjects/Number game/res/background_music.wav";
