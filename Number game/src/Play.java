...
public class Play extends JPanel {
    ...
    private void createGUI() {
        ...
        playScore = new JLabel("Score: " + scoreFiles.intScore("C:/Users/prash/IdeaProjects/Number game/scores/live_score.txt") + "   Games: " + scoreFiles.intScore("scores/num_game.txt"));
        ...
        jLabel.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if(dialogResult == 0) {
                    ...
                    scoreFiles.compareScore("scores/high_score.txt", "C:/Users/prash/IdeaProjects/Number game/scores/live_score.txt", "scores/num_game.txt");
    ...
    protected void paintComponent(Graphics g) {
        g.drawImage(new ImageIcon("C:/Users/prash/IdeaProjects/Number game/res/background2.png").getImage(), 0, 0, null);
    }
    ...
    private void changeStatus(JTextField input, JLabel mysterynum, int randnum, JLabel status, JPanel gridPanel, JLabel contButton, JLabel backButton){
        ...
        if (String.valueOf(randnum).equals(input.getText())) {
            ...
            scoreFiles.write("C:/Users/prash/IdeaProjects/Number game/scores/live_score.txt", scoreFiles.intScore("C:/Users/prash/IdeaProjects/Number game/scores/live_score.txt") + scoringSystem.getScore());
